  ...
  return (
    <section className="section-wrap py-24">
      ...
      >
        ...
        <p className="relative text-xs uppercase tracking-[0.24em] text-cyan-300">Registration Open</p>
        <h2 className="relative mt-4 font-display text-3xl font-bold text-white md:text-5xl">Limited seats for premium technical tracks.</h2>
        <p className="relative mt-4 max-w-2xl text-slate-300">
          Reserve your slot now for Hackathon, AI Workshop, Paper Presentation, and Technical Quiz.
        </p>
